...
namespace VRStandardAssets.Utils
{
    ...
    public class Reticle : MonoBehaviour
    {
		...
		[SerializeField] private Image m_BackgroundImage;           // Reference to the image component that represents the reticle's outline
        ...
        public void SetPosition ()
        {
			...
			m_Image.color = new Color(m_Image.color.r, m_Image.color.g, m_Image.color.b, 0.05f);
			m_BackgroundImage.color = new Color(m_BackgroundImage.color.r, m_BackgroundImage.color.g, m_BackgroundImage.color.b, 0.05f);
        }
        ...
        public void SetPosition (RaycastHit hit)
        {
			...
			m_BackgroundImage.color = new Color(m_BackgroundImage.color.r, m_BackgroundImage.color.g, m_BackgroundImage.color.b, 0.6f);
        }
    }
}