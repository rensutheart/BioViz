...
//			bool upOrDownDetected = false;
			...
			/*
			// this was necessary because controller input was buggy
			if(!upOrDownDetected && Input.GetButton("Fire1"))
			{
